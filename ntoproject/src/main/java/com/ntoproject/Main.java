...
import com.ntoproject.editables.registered.EventType;

public class Main {
	public enum AppRole implements Role{
		ENTERTAINMENT(
			()->new Permission[]{AppPermission.CREATE_EVENTTYPE,AppPermission.READ_EVENTTYPE,AppPermission.READ_EVENT,AppPermission.CREATE_EVENT,AppPermission.CREATE_SPACE,AppPermission.READ_SPACE},
			()->new Feature[]{
				DefaultFeature.MODEL_EDITING
			}
		),
		CULTURE(
			()->new Permission[]{AppPermission.CREATE_EVENTTYPE,AppPermission.READ_EVENTTYPE,AppPermission.READ_EVENT,AppPermission.CREATE_EVENT,AppPermission.READ_EXPOSITION,AppPermission.CREATE_EXPOSITION},
			()->new Feature[]{
				DefaultFeature.MODEL_EDITING
			}
		),
		EDUCATION(
			()->new Permission[]{AppPermission.CREATE_EVENTTYPE,AppPermission.READ_EVENTTYPE,AppPermission.READ_EVENT,AppPermission.CREATE_EVENT,AppPermission.READ_TEACHER,AppPermission.CREATE_TEACHER,AppPermission.CREATE_STUDIO,AppPermission.READ_STUDIO},
			()->new Feature[]{
				DefaultFeature.MODEL_EDITING
			}
		),;
	...
	public static void main(String[]args){
		// new com.bpa4j.util.codegen.ProjectGraph(new java.io.File("C:\\Users\\user\\Desktop\\IT\\Java\\1C\\NTO training\\team\\T3\\ntoproject\\src\\main\\java")).show();
		// new com.bpa4j.util.codegen.ProjectGraph(new java.io.File("C:\\Users\\ice_d\\Desktop\\Моё\\Програмирование\\NTO training\\T3\\ntoproject\\src\\main\\java")).show();
		Navigator.init();
		...
		if(ProgramStarter.firstLaunch){
			...
			EditableGroup<Event>events=new EditableGroup<>(
				new PathIcon("ui/factory.png",Root.SCREEN_SIZE.height/11,Root.SCREEN_SIZE.height/11),
				new PathIcon("ui/factory.png",Root.SCREEN_SIZE.height/11,Root.SCREEN_SIZE.height/11),
				Event.class
			);
			EditableGroup<EventType>eventTypes=new EditableGroup<>(
				new PathIcon("ui/order.png",Root.SCREEN_SIZE.height/11,Root.SCREEN_SIZE.height/11),
				new PathIcon("ui/order_add.png",Root.SCREEN_SIZE.height/11,Root.SCREEN_SIZE.height/11),
				EventType.class
			);            
